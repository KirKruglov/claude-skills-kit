## What changed
<!-- New skill / Update to existing skill / Documentation / Community files -->

## Linked issue
<!-- If this is a new skill, link to the skill_request issue where the idea was discussed. -->
...
### For updates
- [ ] EN and RU README content is in sync
- [ ] No broken links

### General
- [ ] Self-reviewed the diff
- [ ] Tested in target platform (Cowork / Claude.ai / Projects)
