...
1. Download `project-onboarding.zip` from [Releases](https://github.com/KirKruglov/claude-skills-kit/releases)
...
cp -r claude-skills-kit/skills/project-management/project-onboarding ~/.claude/skills/
```
