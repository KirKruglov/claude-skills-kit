...
![Skills](https://img.shields.io/badge/skills-76-informational?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/KirKruglov/claude-skills-kit?style=flat-square)

76 готовых скилл-агентов для Claude — созданы для нетехнических специалистов в командах продукта, операций, финансов, HR и отраслевых направлений.

> 69 отдельных скиллов + 7 вложенных скиллов в `project-management-kit`
